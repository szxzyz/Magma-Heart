...
const features = [
  ...
  },
  {
    ...
    desc: "Earn 0.01 GRAM when a referred friend collects 100 AXN, plus a 5% commission on their deposits.",
    color: "#8b5cf6",
    bullets: ["0.01 GRAM per milestone", "5% deposit commission", "Automatic distribution"],
  },
  {
    Icon: IconTrade,
          ...
          <div ref={about.ref} className="grid md:grid-cols-2 gap-16 items-start">
            ...
            >
              {[
                ...
                { label: "Referral Milestone", val: "0.01 GRAM at 100 AXN", color: "#8b5cf6" },
