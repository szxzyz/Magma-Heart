  ...
  return (
    <PopupShell onClose={onClose}>
        ...
        <div style={{ display: "grid", gap: 16, color: "rgba(255,255,255,0.48)", fontSize: 12, lineHeight: 1.5 }}>
          <div><strong style={{ color: "#3b82f6" }}>Friend Reward</strong><br />Your referred friend must collect <strong style={{ color: "#fff" }}>100 AXN</strong>. Once they reach 100 AXN, you automatically receive <strong style={{ color: "#fff", display: "inline-flex", alignItems: "center", gap: 4 }}>0.01 <TonIcon size={13} /></strong>.</div>
