...
export const users = pgTable("users", {
  ...
  // Earning currency balance, stored directly in GRAM.
  balance: decimal("balance", { precision: 30, scale: 10 }).default("0"),
  ...
  miningBalance: decimal("mining_balance", { precision: 20, scale: 10 }).default("0"),
...
export const referrals = pgTable("referrals", {
  ...
  rewardAmount: decimal("reward_amount", { precision: 30, scale: 10 }).default("0.01"),
